import { Notes, Split } from 'mdx-deck';
...
```js 6,19 file=./code/ProductBuilder.class.basic.0.js
```
...
```js 8,11:13,19 file=./code/ProductBuilder.class.basic.0.js
```
...
```js 7,10,17:19,26:30 file=./code/ProductBuilder.class.multipleState.0.js
```
...
```js 13:19 file=./code/ProductBuilder.class.documentTitle.1.js
```
...
```js 8,50 file=./code/ProductBuilder.class.windowWidth.2.js
```
...
```js 12,15,17:18,28:30 file=./code/ProductBuilder.class.windowWidth.2.js
```
...
```js 24:26 file=./code/ProductBuilder.class.windowWidth.2.js
```
...
```js 8,12,15,17:18,24:26,28:30 file=./code/ProductBuilder.class.windowWidth.2.js
```
